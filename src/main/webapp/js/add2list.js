$(function(){
    var song = [
		{
			...
			'src' : 'track/song/Aquilo - Losing You.mp3',
			'title' : 'Aquilo - Losing You'
		},
	];
	...
	audioFn.newSong({
		...
		'src' : 'track/song/Alex Masters - Breakable.mp3',
		'title' : 'Alex Masters - Breakable.mp3'
	},false);
